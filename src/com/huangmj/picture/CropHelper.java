...
public class CropHelper {
    ...
    public static Uri generateUri() {
    	String fileFolder = Environment.getExternalStorageDirectory() + File.separator + CROP_CACHE_FOLDER;
        File cacheFolder = new File(fileFolder);
    ...
    private static void onPhotoCropped(CropHandler handler, CropParams cropParams) {
        if (cropParams.compress) {
            ...
            handler.onPhotoCropped(cropParams.uri,filepath);
        }
    }
